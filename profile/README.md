...
**Community infrastructure and collaborative spaces**

</div>

---

Community infrastructure, member management, governance, forums, shared resources, collaborative spaces

## Repositories

<!-- This section will be populated after repos are deployed to this org. -->
<!-- Use: gh repo list organvm-vi-koinonia --json name,description --template '...' -->
...
<sub>ORGAN VI: Koinonia &mdash; part of the eight-organ creative-institutional system</sub>
